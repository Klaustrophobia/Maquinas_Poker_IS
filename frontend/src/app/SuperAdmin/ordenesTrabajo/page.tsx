    ...
    <div className="space-y-8">
      ...
      {modalDetalles && solicitudSeleccionada && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl p-6 w-full max-w-4xl max-h-[90vh] overflow-y-auto bg-gradient-to-bl from-green-500/40 to-red-600/40">
      ...
      {modalAsignacion && solicitudSeleccionada && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto bg-gradient-to-bl from-green-500/40 to-red-600/40">
            <div className="flex items-center justify-between mb-6 ">
              <div>
          ...
          {loading ? (
            ...
            <div className="space-y-4 p-6">
              {solicitudesFiltradas.map((solicitud) => (
                <div key={solicitud.id} className="bg-white/80 backdrop-blur-sm rounded-xl shadow-sm hover:shadow-md transition-all p-6 border-l-4 border-green-500">
